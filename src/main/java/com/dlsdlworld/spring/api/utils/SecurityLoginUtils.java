 ...
 */
@Slf4j
public final class SecurityLoginUtils {

    private SecurityLoginUtils() {}
    ...
    private static String extractPrincipal(Authentication authentication) {
        if (authentication == null) {
            ...
            return springSecurityUser.getUserNm();
     ...
     * 회원 가입시 ROLE_ANOYMUS의 경우에는 인증 userId가 존재 하지 않으므로 0L을 리턴한다.
     * @return
     */
    ...
    public static Long getCurrentUserId() {
        ...
        try {
            ...
            UserDetails userDetails =   mapper.readerFor(UserDetails.class).readValue(userLoginJson);
  /*
