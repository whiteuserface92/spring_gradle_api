...
import com.dlsdlworld.spring.api.model.BaseUserAgrmnt;
...
public interface BaseUserAgrmntRepository<T extends BaseUserAgrmnt> extends PagingAndSortingRepository<T, Long> {
