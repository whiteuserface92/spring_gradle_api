...
import com.dlsdlworld.spring.api.model.BaseHospitalAdminMap;
...
public interface BaseHospitalAdminMapRepository<T extends BaseHospitalAdminMap> extends PagingAndSortingRepository<T, Long> {
    @Override
