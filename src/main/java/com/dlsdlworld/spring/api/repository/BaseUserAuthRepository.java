...
import com.dlsdlworld.spring.api.model.BaseUserAuth;
...
public interface BaseUserAuthRepository<T extends BaseUserAuth> extends PagingAndSortingRepository<T, Long> {
