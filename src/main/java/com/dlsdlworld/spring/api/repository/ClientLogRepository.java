...
public interface ClientLogRepository<T extends ClientLog> extends PagingAndSortingRepository<T, Long>{

  @Transactional(readOnly=true)
  @LogAdminExecution(descriptions = "클라이언트 로그 조회")
  ...
  @Query( " select     a  " +
          ...
          " AND (" +
          "        ( a.clientCd like CONCAT('%',:keyword,'%') OR :keyword = '' ) "  +
          "          OR  ( a.funcCall like CONCAT('%',:keyword,'%') OR :keyword = '' )" +
          "          OR  ( a.argsParam like CONCAT('%',:keyword,'%') OR :keyword = '' )" +
          "          OR  ( a.logData like CONCAT('%',:keyword,'%') OR :keyword = '' )" +
          "          OR  ( a.userIp like CONCAT('%',:keyword,'%') OR :keyword = '' )" +
          "        OR  ( a.userAccnt like CONCAT('%',:keyword,'%') OR :keyword = '' )  " +
          "     ) " )
  Page<ClientLog> findAllByKeyword(Pageable page,
