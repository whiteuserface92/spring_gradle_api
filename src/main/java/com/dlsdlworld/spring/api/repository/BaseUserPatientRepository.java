...
import com.dlsdlworld.spring.api.model.BaseUserPatient;
...
public interface BaseUserPatientRepository<T extends BaseUserPatient> extends PagingAndSortingRepository<T, Long> {
