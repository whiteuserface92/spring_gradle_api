...
import com.dlsdlworld.spring.api.model.BaseMenuRole;
...
public interface BaseMenuRoleRepository<T extends BaseMenuRole> extends PagingAndSortingRepository<T, Long> {
