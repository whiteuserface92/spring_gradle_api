...
import com.dlsdlworld.spring.api.model.BaseHospitalMenuCstm;
...
public interface BaseHospitalMenuCsmtRepository<T extends BaseHospitalMenuCstm> extends PagingAndSortingRepository<T, Long> {
