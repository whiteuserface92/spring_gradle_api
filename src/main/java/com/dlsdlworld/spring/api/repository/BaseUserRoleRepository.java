...
import com.dlsdlworld.spring.api.model.BaseUserRole;
...
public interface BaseUserRoleRepository<T extends BaseUserRole> extends PagingAndSortingRepository<T, Long> {

    <U, R> Long countByUserAndRole(U user, R role);
