...
import com.dlsdlworld.spring.api.model.BaseAuthPwd;
...
public interface BaseAuthPwdRepository<T extends BaseAuthPwd> extends PagingAndSortingRepository<T, Long> {
    ...
    T findByUserAccnt(String userAccnt);
