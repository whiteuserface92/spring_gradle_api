...
import com.dlsdlworld.spring.api.basemodel.BaseAppVersion;
...
public interface BaseAppVersionRepository<T extends BaseAppVersion> extends PagingAndSortingRepository<T, Long> {
    @Override
