...
//import com.dlsdlworld.spring.api.basemodel.BaseDomainDic;
...
//public interface BaseDomainDicRepository<T extends BaseDomainDic> extends PagingAndSortingRepository<T, Long> {
//
//    @Override
...
//
//    @Override
//    @LogAdminExecution(code = ActionTypes.CREATE, descriptions = "용어 사전 생성/수정")
...
//
//    @Override
//    @LogAdminExecution(code = ActionTypes.DELETE, descriptions = "용어 사전 삭제")
