...
//import com.dlsdlworld.spring.api.basemodel.BaseBoardPost;
...
//public interface BaseBoardPostRepository<T extends BaseBoardPost> extends PagingAndSortingRepository<T, Long> {
//
//    @Override
...
//
//    @Override
//    @LogAdminExecution(code = ActionTypes.DELETE, descriptions = "게시물 삭제")
