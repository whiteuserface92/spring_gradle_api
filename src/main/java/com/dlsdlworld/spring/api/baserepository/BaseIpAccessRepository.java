...
import com.dlsdlworld.spring.api.basemodel.BaseIpAccess;
...
public interface BaseIpAccessRepository<T extends BaseIpAccess> extends PagingAndSortingRepository<T, Long> {
