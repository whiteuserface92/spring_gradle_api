...
//
//import com.dlsdlworld.spring.api.basemodel.BaseCertInfo;
...
//public interface BaseCertInfoRepository<T extends BaseCertInfo> extends PagingAndSortingRepository<T, Long> {
//
//    @Override
...
//
//    @Override
//    @PreAuthorize("@security.hasPermission({'CERT_READ', 'INSU_READ'})")
